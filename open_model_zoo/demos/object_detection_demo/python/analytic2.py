...
def draw_detections(frame, detections, palette, labels, output_transform, tracker = None):
...
def main():
    ...
    while True:
        ...
        if results:
            ...
            frame = draw_detections(frame, objects, palette, model.labels, output_transform, tracker)
    ...
    for next_frame_id_to_show in range(next_frame_id_to_show, next_frame_id):
        ...
        presenter.drawGraphs(frame)
        rendering_start_time = perf_counter()
        frame = draw_detections(frame, objects, palette, model.labels, output_transform, encoder)
        render_metrics.update(rendering_start_time)
        metrics.update(start_time, frame)
